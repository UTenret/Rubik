...
enum EdgePositions { UB, UR, UF, UL, DR, DF, DL, DB, FR, FL, BR, BL };

enum CornerPositions { UBL, UBR, UFR, UFL, DBL, DBR, DFR, DFL };
...
const std::vector<std::string> group0Moves = {"U", "U'", "F", "F'", "R", "R'",
											  "D", "D'", "L", "L'", "B", "B'"};
const std::vector<std::string> group1Moves = {"U",	"U'", "D",	"D'", "R",
											  "R'", "L",  "L'", "F2", "B2"};
const std::vector<std::string> group2Moves = {"U", "U'", "D", "D'", "R2", "L2", "F2", "B2"};
const std::vector<std::string> group3Moves = {"U2", "D2", "R2", "L2", "F2", "B2"};
